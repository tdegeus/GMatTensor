...
{
    return detail::impl_A2<T, 3>::ret0(A, ret, [](const auto& a) { return pointer::Trace(a); });
}
...
{
    return detail::impl_A2<T, 3>::ret0(A, ret, [](const auto& a) { return pointer::Det(a); });
}
...
{
    return detail::impl_A2<T, 3>::B2_ret2(
...
{
    return detail::impl_A2<T, 3>::B2_ret4(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
...
{
    return detail::impl_A4<T, 3>::B2_ret2(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
...
{
    return detail::impl_A4<T, 3>::B2_ret4(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
