...
{
    array_type::tensor<double, 2> ret = xt::zeros<double>({2, 2});
    return ret;
}

inline array_type::tensor<double, 4> O4()
{
    array_type::tensor<double, 4> ret = xt::zeros<double>({2, 2, 2, 2});
    return ret;
}
...
{
    return detail::impl_A2<T, 2>::ret0(A, ret, [](const auto& a) { return pointer::Trace(a); });
}
...
inline void hydrostatic(const T& A, R& ret)
{
    return detail::impl_A2<T, 2>::ret0(
        A, ret, [](const auto& a) { return pointer::Hydrostatic(a); });
}
...
{
    return detail::impl_A2<T, 2>::ret0(
        A, ret, [](const auto& a) { return pointer::Norm_deviatoric(a); });
}
...
{
    return detail::impl_A2<T, 2>::B2_ret2(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
...
{
    return detail::impl_A2<T, 2>::B2_ret4(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
...
{
    return detail::impl_A4<T, 2>::B2_ret2(
        A, B, ret, [](const auto& a, const auto& b, const auto& r) {
